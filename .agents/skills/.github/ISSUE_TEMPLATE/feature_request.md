...
> [!NOTE]
> Feature requests are accepted only if the proposed skill fills a verified gap in state-of-the-art
> LLMs. To assess this, please test your use case against both a fast model (e.g., Gemini 3 Flash) and
> a reasoning/thinking model (e.g., Gemini 3.1 Pro).
