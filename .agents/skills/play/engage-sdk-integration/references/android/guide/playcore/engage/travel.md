...
- **Recommendation** clusters show personalized travel \& event suggestions
  ...
  recommendations.
    ...
    - A Recommendation cluster can be made of `ArticleEntity`, `EventEntity`, `LodgingEntity`,
      `PointOfInterestEntity`, or `StoreEntity` listings, but not a mix of different entity types.
    ...
    - **Entity:** An object representing a single item in a cluster. This
      ...
      Recommendation Cluster:
        ...
        - **ArticleEntity**: ArticleEntity represents a recommendation for
          ...
          ![](https://developer.android.com/static/images/guide/playcore/engage/article-entity-travel.png)
        ...
        - **EventEntity**: EventEntity represents an event happening in the
          ...
          ![](https://developer.android.com/static/images/guide/playcore/engage/event-entity-travel.png)
        ...
        - **LodgingEntity**: LodgingEntity represents an accommodation, such
          ...
          ![](https://developer.android.com/static/images/guide/playcore/engage/lodging-entity-travel.png)
        ...
        - **StoreEntity**: StoreEntity represents a store, restaurant, cafe
          ...
          ![](https://developer.android.com/static/images/guide/playcore/engage/store-entity-travel.png)
        ...
        - **PointOfInterestEntity**: PointOfInterestEntity represents a
          ...
          ![](https://developer.android.com/static/images/guide/playcore/engage/poi-entity-travel.png)
...
- The **Reservation** cluster shows content recently engaged by users from
  ...
  Your reservation content can take the following structure:
    - **RestaurantReservationEntity**: RestaurantReservationEntity represents
      ...
      ![](https://developer.android.com/static/images/guide/playcore/engage/restaurant-reservation-entity-travel.png)
    ...
    - **EventReservationEntity**: EventReservationEntity represents a
      ...
      following:
        ...
        - Entertainment events like reservation for movies in a cinema, concert, theater, book
          signing
      ...
      ![](https://developer.android.com/static/images/guide/playcore/engage/event-reservation-entity-travel.png)
    ...
    - **LodgingReservationEntity**: LodgingEntityReservation represents a
      ...
      ![](https://developer.android.com/static/images/guide/playcore/engage/lodging-reservation-entity-travel.png)
    ...
    - **TransportationReservationEntity**: TransportationReservationEntity
      ...
      ![](https://developer.android.com/static/images/guide/playcore/engage/transportation-reservation-entity-travel.png)
      **Figure 9.** UI showing a single TransportationReservationEntity within a Reservation
      cluster.
    - **VehicleRentalReservationEntity**: VehicleRentalReservationEntity
      ...
      ![](https://developer.android.com/static/images/guide/playcore/engage/vehicle-rental-reservation-entity-travel.png)
      **Figure 10.** UI showing a single VehicleRentalReservationEntity within a Reservation
      cluster.
- The **Featured** cluster showcases a selection of entities from multiple
  ...
  broadcast up to 10 entities in the Featured cluster.
    ...
    - **GenericFeaturedEntity**: GenericFeaturedEntity differs from
      ...
      ![](https://developer.android.com/static/images/guide/playcore/engage/featured-cluster-travel.png)
...
- The **Continue Search** cluster helps users resume their previous travel
  ...
  up to 3 entities in the Continue Search cluster.
    ...
    - **PointOfInterestEntity:** PointOfInterestEntity represents a place of interest like, a gas
      station, event venue, theme park, museum, tourist attraction, hiking trail etc. It highlights
      content the user has previously searched for.
...
1. Some entities like **ArticleEntity** and **GenericFeaturedEntity** are eligible to use any of the
   ...
   *PointOfInterestEntity**, only a subset of these categories are eligible. Check the list of
   categories eligible for an entity type before populating the list.
...
> [!IMPORTANT]
> **Important:** The publish APIs replace any existing content. **Don't** call delete and publish
> APIs subsequently to replace the content, as the publish APIs do that inherently.
...
- `com.google.android.engage.action.travel.PUBLISH_CONTINUE_SEARCH` It is recommended to start a
  `publishContinueSearchCluster` call when receiving this intent.
- `com.google.android.engage.action.travel.PUBLISH_RESERVATION` It is recommended to start a
  `publishReservationCluster` call when receiving this intent.
...
- After Google has confirmed that your updated APK has been published to the Play Store, your *
  *Recommendation** , **Featured** , **Reservation** , and **Continue Search** clusters may be
