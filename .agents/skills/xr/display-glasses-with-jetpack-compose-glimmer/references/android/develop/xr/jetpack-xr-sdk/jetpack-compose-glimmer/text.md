...
`Text`](https://developer.android.com/reference/kotlin/androidx/xr/glimmer/Text.composable)
component lets you set various text
...
- Because no color is specified, this text looks at the nearest surface to pick the best readable
  color (usually white).
...
[Google Sans Flex](https://fonts.google.com/specimen/Google+Sans+Flex?query=google+sans&preview.script=Latn)
is a variable font specifically chosen for AI
...
dependencies](https://developer.android.com/develop/xr/jetpack-xr-sdk/set-up-sdk#augmented), then
apply the font globally to the `GlimmerTheme`:
