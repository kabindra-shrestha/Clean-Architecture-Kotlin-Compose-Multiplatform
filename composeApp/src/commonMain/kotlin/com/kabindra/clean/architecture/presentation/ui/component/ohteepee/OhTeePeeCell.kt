package com.kabindra.clean.architecture.presentation.ui.component.ohteepee
        ...
        BasicTextField(
            ...
            modifier = Modifier
                .conditional(value.isEmpty()) {
                    onPreviewKeyEvent {
                        ...
                        if (isDeleteKey && it.type == KeyEventType.KeyDown) {
                            onValueChange("")
            ...
            TextFieldDefaults.DecorationBox(
                ...
                colors = TextFieldDefaults.colors(
                    focusedContainerColor = cellConfiguration.backgroundColor,
                    focusedIndicatorColor = cellConfiguration.backgroundColor,
                    unfocusedContainerColor = cellConfiguration.backgroundColor,
                    unfocusedIndicatorColor = cellConfiguration.backgroundColor
                ),
            )
        }
    }
